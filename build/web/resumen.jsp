...
<html>
    <head>
        ...
        <%
          int ncalc = !request.getParameter("calc").equals("")?Integer.parseInt(request.getParameter("calc")):0;
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="text-right">
                                            <span class="badge badge-primary"><%=ncalc%></span>
                                        </p>
                                    </td>
                                     <td>
                                        <p class="text-right">
                                            <span class="badge badge-primary"><%=(ncalc*50)%></span>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                       <p class="text-right">
                                            <span class="badge badge-primary"><%=ncomp%></span>
                                        </p>
                                    </td>
                                     <td>
                                        <p class="text-right">
                                            <span class="badge badge-primary"><%=(ncomp*5000)%></span>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                         <p class="text-right">
                                            <span class="badge badge-primary"><%=nmoni%></span>
                                        </p>
                                    </td>
                                     <td>
                                        <p class="text-right">
                                            <span class="badge badge-primary"><%=(nmoni*2000)%></span>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-right">
                                            <span class="badge badge-primary"><%=ntecl%></span>
                                        </p>
                                    </td>
                                     <td>
                                        <p class="text-right">
                                            <span class="badge badge-primary"><%=(ntecl*100)%></span>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-right">
                                            <span class="badge badge-primary"><%=nmous%></span>
                                        </p>
                                    </td>
                                     <td>
                                        <p class="text-right">
                                            <span class="badge badge-primary"><%=(nmous*70)%></span>
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr class="bg-dark">
                                    ...
                                    <td><p class="text-right text-light font-weight-bold">$<%=total%></p></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
